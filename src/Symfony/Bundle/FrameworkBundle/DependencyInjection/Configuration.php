...
class Configuration implements ConfigurationInterface
{
    ...
    public function getConfigTreeBuilder(): TreeBuilder
    {
        ...
        $this->addFeatureFlagsSection($rootNode, $enableIfStandalone);
    ...
    private function addFeatureFlagsSection(ArrayNodeDefinition $rootNode, callable $enableIfStandalone): void
    {
        $knownStrategyTypes = [
            'grant',
            'deny',
        ...
        $rootNode
            ->children()
                ->arrayNode('feature_flags')
                    ->info('FeatureFlags configuration')
                    ->{$enableIfStandalone('symfony/feature-flags', FeatureCheckerInterface::class)}()
                    ->children()
                        // strategies
                            ...
                            ->arrayPrototype()
                                ->children()
                                    ...
                                    ->scalarNode('type')
                                        ->isRequired()
                                        ->cannotBeEmpty()
                                        ->info(sprintf('Can be one of : %s. Or a service ID.', implode(', ', $knownStrategyTypes)))
